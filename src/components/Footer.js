      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mt-4 mb-6">
              Professional construction estimation services with unmatched accuracy and speed.
            </p>
          ...
          {footerLinks.map((column, index) => (
            <motion.div 
              ...
              className="space-y-4"
            >
              <h3 className="text-lg font-semibold text-white mb-4 font-serif">{column.title}</h3>
          ...
          >
            ...
            <address className="text-gray-400 not-italic space-y-3">
              <div className="flex items-start">
                <svg className="flex-shrink-0 w-5 h-5 text-gold-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start">
                ...
                <Link href="tel:+12125551234" className="hover:text-gold-400 transition-colors">
                  (212) 555-1234
                </Link>
              </div>
              ...
              <div className="flex items-start">
                ...
                <Link href="mailto:info@1stestimator.com" className="hover:text-gold-400 transition-colors">
        ...
        >
          ...
          <div className="flex space-x-6">
            <Link href="/privacy" className="text-gray-500 hover:text-gold-400 text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-gray-500 hover:text-gold-400 text-sm transition-colors">
              Terms of Service
            </Link>
            <Link href="/cookies" className="text-gray-500 hover:text-gold-400 text-sm transition-colors">
              Cookie Policy
            </Link>
          </div>
        </motion.div>
